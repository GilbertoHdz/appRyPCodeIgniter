$(document).ready(function () {
    ...
    $(".editar").on('click', function () {
        ...
        $("<div class='edit_modal'><form name='edit' id='edit' method='post' action='http://localhost/appRyP/usuario_ci/multi_user'>"+
                        ...
                        $.ajax({
                            ...
                            success:function (data) {
                                ...
                                if(obj.respuesta == 'error')
                                {
                                    ...
                                    setTimeout(function() {
                                        window.location.href = "http://localhost/appRyP/usuario_ci/";
                                    }, 2000);
        ...
        $("<div class='delete_modal'>¡Estás seguro que deseas eliminar al usuario " + nombre + "?</div>").dialog({
            ...
            buttons:{
                ...
                "Eliminar":function () {
                    $.ajax({
                        type:'POST',
                        url:'http://localhost/appRyP/usuario_ci/delete_user',
                        async: true,
                        data: { id : id },
                        complete:function () {
    ...
    $(".agregar").on('click', function () {
        ...
        $("<div class='insert_modal'><form name='insert' id='insert' method='post' action='http://localhost/appRyP/usuario_ci/multi_user'>"+
