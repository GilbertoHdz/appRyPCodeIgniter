...
class Diplomaemitido_model extends CI_Model {

	public function getDataDiploma()
	{
		$query = "Select mu.username,mc.id as curso, no_matriculacion.cantidad_matriculaciones,
				if(mue.status=0,'NO','SI') as suspendido, if(mid3.data = 1, 'SI','NO') as estadopago,
				if(mid.data='BAJA DEFINITIVA','SI','NO') as bajaDef,
				...
				SUBSTRING(mc.fullname,1,LOCATE('(', fullname)-1) as Diplomado,
				mid6.data as matricula, mid7.data as folio,	if(mid8.data = 1, 'SI','NO') as impreso,
				...
				truncate((mgg1.cal_ponderada+mgg2.cal_ponderada+mgg3.cal_ponderada+mgg4.cal_ponderada+mgg5.cal_ponderada+mgg6.cal_ponderada
				+mgg72.cal_ponderada),2) as tema1,
				truncate((+mgg8.cal_ponderada+mgg9.cal_ponderada+mgg10.cal_ponderada+mgg11.cal_ponderada+mgg12.cal_ponderada
				+mgg13.cal_ponderada+mgg142.cal_ponderada),2) as tema2,
				truncate((mgg15.cal_ponderada+mgg16.cal_ponderada+mgg17.cal_ponderada+mgg18.cal_ponderada
				...
				if(remedial.id_usuario is null,'NO','SI') as pertenece_remedial,
				truncate(rem.calificacion,2) as calificacion_curso_remedial,
				mid10.data as email_alt, mid11.data as nombrect, mid12.data as nivelct,
...
/* End of file diplomaemitido_model.php */
/* Location: ./application/models/diplomaemitido_model.php */