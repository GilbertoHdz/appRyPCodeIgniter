...
class Segdocente_model extends CI_Model {
	...
	public function getSegDocente()
	{
		...
		$query = "select mid.data as estadoPlataforma,IF(mid3.data=1,'SI','NO') as CONFIRMACION_INFORMACION,
			...
			if(mid5.data=1,'SI','NO') as aplica_entrega,
			if(remedial.id_usuario is null,'NO','SI') as pertenece_remedial,
			if(mid10.data is null,'SI',mid10.data) as estado_participacion, 
			if(mid11.data = 1,'SI','NO') as estado_pago,
