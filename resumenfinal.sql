select mid.data as estadoPlataforma, (case when mid3.data = '1' then 'SI' else 'NO' end) as CONFIRMACION_INFORMACION,
...
mgg72.cal_ponderada as CalCOALESCEicacion_producto1,
...
mgg142.finalgrade as CalCOALESCEicacion_producto2,
...
mgg212.finalgrade as CalCOALESCEicacion_producto3,
case 
...
end as CalCOALESCEicacion_Actual,
case 
...
end as CalCOALESCEicacion_No_Recuperable,
case 
...
end as CalCOALESCEicacion_Alcanzable
from mdl_user mu
